...
function Contact() {
  ...
  const onSubmit = async(data) => {
    const userInfo={
      access_key:"7d4ea925-796f-4e9d-ae08-e27248739cf1",
      name: data.username,
      email: data.email,
    ...
    <div className='bg-gray-50 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-4xl w-full space-y-8 bg-white p-10 rounded-lg shadow-lg'>
        ...
        <div className='flex flex-col md:flex-row justify-between'>
          ...
          <h3 className='text-lg font-medium text-gyay-700 mb-4'>Send us a message</h3>
          ...
          <ul className='space-y-4'>
            <li className='flex items-center space-x-2'>
              ...
              <span>+91 9334966286</span>
            </li>
            <li className='flex items-center space-x-2'>
             <FaEnvelope className="text-pink-500"/>
              <span>shuklapuja2003@gmail.com</span>
            </li>
             <li className='flex items-center space-x-2'>
